...
function Header({ user }: { user: User }) {
  ...
  return (
    <div>
      <img className="logo" alt="1663 Console" src="/logo.png" />
      <div className="actions">
        ...
        <div className="help">
          <a href="https://www.1663.io" target="_blank" rel="noreferrer">
        ...
        <a href="https://1663.io/contact" target="_blank" rel="noreferrer">
            <Button type="primary">
              Upgrade to Pro
            </Button>
            </a>
